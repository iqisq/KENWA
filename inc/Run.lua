...
local url , res = https.request('https://google.com'..SUDO_USER)
if res ~= 200 then
...
print("The File "..name.." Not Runing in The Source kenwa")
end 

end
else
print("The File Script.lua Not Runing in The Source kenwa")
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/KENANali9/kenwa/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/KENANali9/kenwa/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/KENANali9/kenwa/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/KENANali9/kenwa/master/inc/functions.lua','./inc/functions.lua')
