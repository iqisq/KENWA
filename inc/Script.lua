...
if not msg.Creator then return "📛*¦* هذا الامر يخص {المطور,المطور الاساسي,المنشئ} فقط  \n🚶" end
if not MsgText[2] and msg.reply_id then
...
sendMsg(msg.chat_id_,msg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس كينوا يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : كينوا 🍃",url="t.me/kenwa"}}}
...
⚜┇Welcome to kenwa source
            ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🔱↬   [Install source](t.me/kenwa) 
...
local inline = {{{text="آلمـطـور Ω",url="t.me/"..xsudouser}}}
